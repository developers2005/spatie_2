                                            ...
                                            <div class="col-span-12 sm:col-span-2">
                                                ...
                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                    <input type="text" name="name" id="name"
                                                        ...
                                                        placeholder="Post name" value="{{ $role->name }}">
                                                </div>
                                                @error('name')
                    ...
                    <div class="flex space-x-2 mt-4 p-2">
                        @if ($role->permissions)
                            @foreach ($role->permissions as $permission)
                                ...
                                action="{{route('admin.roles.permissions.revoke', [$role->id,$permission->id])}}" method="POST" onsubmit="return confirm('Are your sure?')">
                                    @csrf
                                    @method('DELETE')
